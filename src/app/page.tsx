...
const featured = [
  ...
  { title: "ZaccPos", href: "/projects#zaccpos", img: "/projects/zaccpos.png" },
];
...
export default function Home() {
  return (
    <>
      <Navbar />
      <main className="pt-20 bg-gray-800 min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 py-10">
          ...
          <div className="bg-gray-800 shadow-lg rounded-lg p-8 flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-1/2 mt-8 md:ml-8 text-white">
              ...
              <p className="mt-4">
                A Nairobi-based programmer & techie passionate about privacy,
                open source, Linux & computer architecture. I also tinker with
                repairs—check out my blog for deep dives!
              </p>
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              {featured.map((p) => (
                <Link
                  key={p.title}
                  href={p.href}
                  className="block bg-gray-900 rounded-lg overflow-hidden shadow hover:shadow-2xl transition"
                >
